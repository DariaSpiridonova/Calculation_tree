...
Calculation_Tree_Errors CalculationTreeInit(calculation_tree *tree, const char *logfile_name)
{
    ...
    tree->root->variables_buffer = (char *)calloc(NUM_OF_VARIABLES, sizeof(char));
    tree->root->left = NULL;
    tree->root->right = NULL;
    tree->root->parent = NULL;
    tree->root->type = OP_TYPE;
    tree->root->value.operation = add;
...
void TreeDump(calculation_tree *tree, const char *file, int line)
{
    assert(tree != NULL);
...
void dump_to_console(const calculation_tree *tree, const char *file, int line, ssize_t *rank)
{
...
void dump_to_logfile(const calculation_tree *tree, const char *logfile_name, const char *gvfile_name, ssize_t *rank)
{
...
void create_graph(const calculation_tree *tree, const char *gvfile_name)
{

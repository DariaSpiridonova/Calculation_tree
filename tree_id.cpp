...
Tree_Errors tree_insert(calculation_tree *tree, used_type value)
{
    assert(tree != NULL);
...
Tree_Errors NodeDestroy(calculation_tree *tree, used_type value)
{
    assert(tree != NULL);
...
Tree_Errors NodeInit(calculation_tree *tree, node_t **node, node_t *parent, used_type value)
{
    assert(tree != NULL);
    assert(parent != NULL);
...
Tree_Errors node_delete(calculation_tree *tree, node_t *node, node_t *ptr)
{
    assert(tree != NULL);
    assert(ptr != NULL);
